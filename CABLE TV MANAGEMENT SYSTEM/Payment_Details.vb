...
Public Class Payment_Details
    ...
    Private Sub Guna2GradientButton1_Click(sender As Object, e As EventArgs) Handles Guna2GradientButton1.Click
        ...
        Dim sql As String = "SELECT JANUARY,FEBRUARY,MARCH,APRIL,MAY,JUNE,JULY,AUGUST,SEPTEMBER,OCTOBER,NOVEMBER,DECEMBER FROM CUSTOMER_PAYMENT_DETAILS WHERE CRF = @CRF AND YEAR = @YEAR"
