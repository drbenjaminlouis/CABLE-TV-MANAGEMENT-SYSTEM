...
Public Class TV_CONNECTION_INVOICE_READER
    ...
    Private Sub TV_CONNECTION_INVOICE_READER_Load(sender As Object, e As EventArgs)
        ...
        If Not UserName = Nothing Then
            ...
            If crfreader.HasRows = True Then
                ...
                End While
                Dim command1 As New OleDbCommand("SELECT DISTINCT(PAYMENT_YEAR) FROM TV_PAYMENT_DETAILS WHERE CRF=@CRF", connection)
    ...
    Private Sub CUST_DATA_GRID_SelectionChanged(sender As Object, e As EventArgs)
        If flag = True Then
            If CUST_DATA_GRID.SelectedRows.Count > 0 Then
                ...
                Dim invoicepicker As New OleDbCommand("SELECT INVOICE FROM INVOICE_DETAILS WHERE CRF=@CRF AND SERVICE=@SERVICE AND INVOICE_NO=@INVOICE_NO", connection)
                invoicepicker.Parameters.AddWithValue("@CRF", cust_crf)
                invoicepicker.Parameters.AddWithValue("@SERVICE", "CABLE TV")
                ...
                If reader.HasRows = True Then
                    While reader.Read
                        ...
                        UpdatePdfViewer(filePath)
                    End While
                End If
            End If
        End If
    End Sub
    Private Sub UpdatePdfViewer(filePath As String)
        Dim fileUri As New Uri(filePath, UriKind.RelativeOrAbsolute)
        FILE_PATH = filePath
        If Not fileUri.IsAbsoluteUri Then
            fileUri = New Uri(System.IO.Path.Combine(System.Windows.Forms.Application.StartupPath, filePath))
        End If
    ...
    Private Sub YEAR_COMBOBOX_SelectedIndexChanged(sender As Object, e As EventArgs)
        ...
        End If
    End Sub
    Private Sub DOWNLOAD_BTN_Click(sender As Object, e As EventArgs)
    ...
    Private Sub SEARCH_BTN_Click(sender As Object, e As EventArgs) Handles SEARCH_BTN.Click
        ...
        transfetcher.Parameters.AddWithValue("@SERVICE", "CABLE TV")
